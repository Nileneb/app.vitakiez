<x-layouts::app :title="__('WG bearbeiten: ' . $wg->wg_name)">
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        <!-- Header -->
        <div class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-2">WG bearbeiten</h1>
                    <p class="text-neutral-600 dark:text-neutral-400">{{ $wg->wg_name }}</p>
                </div>
                <a href="{{ route('wgs.show', $wg) }}" class="inline-flex items-center gap-2 rounded-lg bg-neutral-600 hover:bg-neutral-700 text-white px-4 py-2 font-medium transition-colors">
                    Abbrechen
                </a>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-900 max-w-2xl">
            <form method="POST" action="{{ route('wgs.update', $wg) }}" class="space-y-6">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    <input
                        ...
                        id="address_text"
                        name="address_text"
                        value="{{ old('address_text', $wg->address_text) }}"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <input
                        ...
                        id="district"
                        name="district"
                        value="{{ old('district', $wg->district) }}"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <input
                        ...
                        id="municipality"
                        name="municipality"
                        value="{{ old('municipality', $wg->municipality) }}"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('residents_total', $wg->residents_total) }}"
                        min="1"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('residents_with_pg', $wg->residents_with_pg) }}"
                        min="0"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        id="target_group"
                        name="target_group"
                        value="{{ old('target_group', $wg->target_group) }}"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div class="flex items-center gap-3">
                    <input
                        ...
                        value="1"
                        {{ old('has_24h_presence', $wg->has_24h_presence) ? 'checked' : '' }}
                ...
                <div class="flex items-center gap-3">
                    <input
                        ...
                        value="1"
                        {{ old('has_presence_staff', $wg->has_presence_staff) ? 'checked' : '' }}
                        class="w-4 h-4 rounded border-neutral-300 text-blue-600 focus:ring-2 focus:ring-blue-500"
                    />
