<x-layouts::app :title="__('Neue Behörde erstellen')">
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        <!-- Header -->
        <div class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-2">Neue Behörde erstellen</h1>
                    <p class="text-neutral-600 dark:text-neutral-400">Registrieren Sie eine neue Behörde</p>
                </div>
        ...
        <div
            ...
            <form method="POST" action="{{ route('authorities.store') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" id="authority_type" name="authority_type" value="{{ old('authority_type') }}"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="jurisdiction_district" name="jurisdiction_district"
                            value="{{ old('jurisdiction_district') }}"
                            class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        ...
                        <input type="text" id="jurisdiction_municipality" name="jurisdiction_municipality"
                            value="{{ old('jurisdiction_municipality') }}"
                            class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="address_text" name="address_text" value="{{ old('address_text') }}"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <textarea id="office_hours" name="office_hours" rows="2"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Mo-Fr: 09:00-17:00 Uhr">{{ old('office_hours') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="2"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Zusätzliche Informationen...">{{ old('notes') }}</textarea>
                </div>
