<x-layouts::app :title="__('Problem bearbeiten: ' . $issue->name)">
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        <!-- Header -->
        <div class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-2">Problem bearbeiten</h1>
                    <p class="text-neutral-600 dark:text-neutral-400">{{ $issue->name }}</p>
                </div>
        ...
        <div
            ...
            <form method="POST" action="{{ route('issues.update', $issue->id) }}" class="space-y-6">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    <input type="text" id="code" name="code" value="{{ old('code', $issue->code) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $issue->name) }}" required
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Detaillierte Beschreibung des Problems...">{{ old('description', $issue->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="default_authority_targets" name="default_authority_targets" rows="2"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Welche Behörden sind typischerweise zuständig?">{{ old('default_authority_targets', $issue->default_authority_targets) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="default_required_docs" name="default_required_docs" rows="2"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Welche Dokumente werden typischerweise benötigt?">{{ old('default_required_docs', $issue->default_required_docs) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="default_next_actions" name="default_next_actions" rows="2"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Typische Handlungsschritte...">{{ old('default_next_actions', $issue->default_next_actions) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="rule_hints" name="rule_hints" rows="2"
                        class="w-full px-4 py-2 border border-neutral-300 rounded-lg dark:border-neutral-600 dark:bg-neutral-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Wichtige Hinweise und Regeln...">{{ old('rule_hints', $issue->rule_hints) }}</textarea>
                </div>
